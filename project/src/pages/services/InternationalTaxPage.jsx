...
const InternationalTaxPage = () => {
  ...
  const getPageUrl = (language) => {
    switch (language) {
      case 'en':
        return "https://consultgloballex.com/services/international-tax-advisory";
      case 'de':
        return "https://consultgloballex.com/dienstleistungen/internationale-steuerberatung";
      case 'it':
        return "https://consultgloballex.com/servizi/consulenza-fiscale-internazionale";
      case 'es':
      default:
        return "https://consultgloballex.com/servicios/asesoria-fiscal-internacional";
    }
  };

  const currentUrl = getPageUrl(lng);
  const pageKey = "international_tax_page";
